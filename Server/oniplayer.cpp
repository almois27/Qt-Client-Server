...
//OniPlayer::OniPlayer(const char *filePath)
//{
//    qDebug()<<"New device";
//    openni::Status st = openni::OpenNI::initialize();
//    qDebug()<<"initialize status"<<st;
...
//openni::Status OniPlayer::SteamsSeek()
//{
...
//void OniPlayer::ImgFrames(QPixmap *  pixmapRGB, QPixmap *  pixmapDEPTH )
//{
...
//int OniPlayer::getNumberFrames()
//{
//    return pb->getNumberOfFrames(color);
//}


//void OniPlayer::SetFilePath(const char *newFilePath)
//{
